...
class ClubsControllerTest < ActionController::TestCase
  ...
  test "should create club" do
    assert_difference('Club.count') do
      post :create, club: { description: @club.description, jumper: @club.jumper, name: @club.name }
    end
  ...
  test "should update club" do
    patch :update, id: @club, club: { description: @club.description, jumper: @club.jumper, name: @club.name }
    assert_redirected_to club_path(assigns(:club))
  end
